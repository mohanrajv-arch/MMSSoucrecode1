...
@Data
public class RecipeListingDTO implements Serializable {
	...
	private List<RecipeListingDTO> categoryList = new ArrayList<>();
	private List<RecipeListingDTO> mealList = new ArrayList<>();
	private List<RecipeListingDTO> recipeItems = new ArrayList<>();
	...
	public List<RecipeListingDTO> getCategoryList() {
		return categoryList;
	}
	public void setCategoryList(List<RecipeListingDTO> categoryList) {
		this.categoryList = categoryList;
	}
	public List<RecipeListingDTO> getMealList() {
		return mealList;
	}
	public void setMealList(List<RecipeListingDTO> mealList) {
		this.mealList = mealList;
	}
	public List<RecipeListingDTO> getRecipeItems() {
		return recipeItems;
	}
	public void setRecipeItems(List<RecipeListingDTO> recipeItems) {
	...
	public List<RecipeListingDTO> getVersionList() {
		return versionList;
	}
	public void setVersionList(List<RecipeListingDTO> versionList) {
	...
	public List<RecipeListingDTO> getCategoryListName() {
		return categoryListName;
	}
	public void setCategoryListName(List<RecipeListingDTO> categoryListName) {
	...
	public List<RecipeListingDTO> getRecipeSubList() {
		return recipeSubList;
	}
	public void setRecipeSubList(List<RecipeListingDTO> recipeSubList) {
	...
	private List<RecipeListingDTO> versionList = new ArrayList<>();
	private String newRecipeName;
	private int createdBy;
	private String cuisineName;

	private List<RecipeListingDTO> categoryListName = new ArrayList<>();
	...
	private List<RecipeListingDTO> recipeSubList = new ArrayList<>();
