...
public class TracingConfig {
	...
	@Bean
	 Tracer micrometerTracer() {
		...
		Attributes serviceAttrs = Attributes.of(AttributeKey.stringKey("service.name"), "issue-menu-mms");
		...
		return new OtelTracer(openTelemetry.getTracer("issue-menu-mms"), new OtelCurrentTraceContext(),
				span -> {
				});
	}
}
