...
@Table(name = "final_set_menu_d", schema = "dbo")
public class FinalSetMenuDHib implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8640261077965706973L;
