...
@Table(name = "final_set_menu_i", schema = "dbo")
public class FinalSetMenuIHib implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 9124484903521938800L;
