...
public class TracingConfig {
	...
	@Bean
	 Tracer micrometerTracer() {
		...
		Attributes serviceAttrs = Attributes.of(AttributeKey.stringKey("service.name"), "api-gateway-service");
		...
		return new OtelTracer(openTelemetry.getTracer("api-gateway-service"), new OtelCurrentTraceContext(),
				span -> {
				});
	}
}
