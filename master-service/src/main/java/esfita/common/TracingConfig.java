...
public class TracingConfig {
	...
	@Bean
	 Tracer micrometerTracer() {
		...
		Attributes serviceAttrs = Attributes.of(AttributeKey.stringKey("service.name"), "master-service");
		...
		return new OtelTracer(openTelemetry.getTracer("master-service"), new OtelCurrentTraceContext(),
				span -> {
				});
	}
}
