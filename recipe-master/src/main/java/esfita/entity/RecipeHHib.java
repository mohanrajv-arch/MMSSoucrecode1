...
@Entity
@Data
@Table(name = "recipe_h", schema = "dbo")
public class RecipeHHib implements Serializable {

	
		/**
		 * 
		 */
		private static final long serialVersionUID = -68729934125132768L;
	    ...
	    private Set<RecipeCategoryMappingHib> recipeCategoryMappings = new HashSet<>();
	    
	    @OneToMany
	    @JoinColumn(name = "recipe_fk", referencedColumnName = "id")
	    private Set<RecipeCategoryMappingHib> recipeCategoryMapping = new HashSet<>();
	    
	    @OneToMany
	    @JoinColumn(name = "recipe_fk", referencedColumnName = "id")
	    private Set<RecipeMealMappingHib> mealMappings= new HashSet<>();
	    
	    @OneToMany
	    @JoinColumn(name = "recipe_fk", referencedColumnName = "id")
	    private Set<RecipeCategoryMappingHib> categoryMappings= new HashSet<>();

	    @OneToMany
	    @JoinColumn(name = "recipe_fk", referencedColumnName = "id")
	    private Set<RecipeMealMappingHib> recipeMealTypeMappings;
