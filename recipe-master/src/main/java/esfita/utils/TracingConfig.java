...
public class TracingConfig {
	...
	Tracer micrometerTracer() {
		...
		Attributes serviceAttrs = Attributes.of(AttributeKey.stringKey("service.name"), "recipe-master");
		...
		return new OtelTracer(openTelemetry.getTracer("recipe-master"), new OtelCurrentTraceContext(), span -> {
		});
	}
}
