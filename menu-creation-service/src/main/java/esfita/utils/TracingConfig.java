...
public class TracingConfig {
	...
	Tracer micrometerTracer() {
		...
		Attributes serviceAttrs = Attributes.of(AttributeKey.stringKey("service.name"), "menu-creation-service");
		...
		return new OtelTracer(openTelemetry.getTracer("menu-creation-service"), new OtelCurrentTraceContext(), span -> {
		});
	}
}
